 ...
 * C source code generated on : Sat Nov 14 12:12:35 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Add = heli_q8_P.ElevationCounttorad_Gain * rtb_DeadZonex +
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<Root>/Sum2' */
    heli_q8_B.Sum2 = heli_q8_B.PitchCounttorad - heli_q8_B.Joystick_gain_x;
  }

  /* Sum: '<Root>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.ElevationTransferFcn - heli_q8_B.Joystick_gain_y;
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1416890332U);
  heli_q8_M->Sizes.checksums[1] = (4047134920U);
  heli_q8_M->Sizes.checksums[2] = (134692356U);
  heli_q8_M->Sizes.checksums[3] = (1175320679U);
