...
#ifndef RTW_HEADER_lab2first_h_
#define RTW_HEADER_lab2first_h_
#include <stddef.h>
#include <string.h>
#ifndef lab2first_COMMON_INCLUDES_
# define lab2first_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* lab2first_COMMON_INCLUDES_ */

#include "lab2first_types.h"
...
#define lab2first_rtModel              RT_MODEL_lab2first_T
...
#define rtB                            lab2first_B
#define BlockIO                        B_lab2first_T
#define rtX                            lab2first_X
#define ContinuousStates               X_lab2first_T
#define rtXdot                         lab2first_XDot
#define StateDerivatives               XDot_lab2first_T
#define tXdis                          lab2first_XDis
#define StateDisabled                  XDis_lab2first_T
#define rtP                            lab2first_P
#define Parameters                     P_lab2first_T
#define rtDWork                        lab2first_DW
#define D_Work                         DW_lab2first_T

/* Parameters (auto storage) */
struct P_lab2first_T_ {
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: (-2 * pi /4096)
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: -0.54
...
extern P_lab2first_T lab2first_P;

/* Block signals (auto storage) */
extern B_lab2first_T lab2first_B;

/* Continuous states (auto storage) */
extern X_lab2first_T lab2first_X;

/* Block states (auto storage) */
extern DW_lab2first_T lab2first_DW;
...
extern void lab2first_initialize(void);
extern void lab2first_output0(void);
extern void lab2first_update0(void);
extern void lab2first_output(int_T tid);
extern void lab2first_update(int_T tid);
extern void lab2first_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab2first_rtModel *lab2first(void);
...
extern RT_MODEL_lab2first_T *const lab2first_M;
 ...
 *
 * '<Root>' : 'lab2first'
 * '<S1>'   : 'lab2first/Conversion'
 * '<S2>'   : 'lab2first/Heli 3D'
 * '<S3>'   : 'lab2first/Joystick'
 */
#endif                                 /* RTW_HEADER_lab2first_h_ */
