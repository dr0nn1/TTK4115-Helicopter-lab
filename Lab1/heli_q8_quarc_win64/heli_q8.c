...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Add = heli_q8_P.ElevationCounttorad_Gain *
      rtb_HILReadEncoderTimebase_o3 + heli_q8_P.Constant_Value;

    /* Sum: '<S2>/Sum' */
    rtb_DeadZoney = 0.0 - heli_q8_B.Add;

    /* Gain: '<S6>/K_ep' incorporates:
     *  Sum: '<S2>/Sum'
     */
    heli_q8_B.K_ep = (0.0 - heli_q8_B.Add) * heli_q8_P.K_ep_Gain;
   ...
   *  Sum: '<S6>/Sum'
   */
  heli_q8_B.Add_m = ((heli_q8_X.Integrator_CSTATE + heli_q8_B.K_ep) -
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S5>/Add'
     */
    heli_q8_B.Product = (heli_q8_B.Joystick_gain_x - heli_q8_B.PitchCounttorad) *
      heli_q8_P.Kpp;

    /* Constant: '<S5>/Constant1' */
    heli_q8_B.Constant1 = heli_q8_P.Kpd;
  }
   ...
   *  Product: '<S5>/Product1'
   */
  rtb_Backgain = heli_q8_B.Product - heli_q8_B.Constant1 *
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_DeadZoney = (heli_q8_B.Add_m - rtb_Backgain) * heli_q8_P.Frontgain_Gain;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (rtb_DeadZoney > heli_q8_P.FrontmotorSaturation_UpperSat) {
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_DeadZoney < heli_q8_P.FrontmotorSaturation_LowerSat) {
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_LowerSat;
  } else {
    heli_q8_B.FrontmotorSaturation = rtb_DeadZoney;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_DeadZoney = (heli_q8_B.Add_m + rtb_Backgain) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3978631936U);
  heli_q8_M->Sizes.checksums[1] = (1682209777U);
  heli_q8_M->Sizes.checksums[2] = (455588556U);
  heli_q8_M->Sizes.checksums[3] = (1887388719U);
