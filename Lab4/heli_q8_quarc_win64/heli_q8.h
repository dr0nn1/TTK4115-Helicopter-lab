...
/* Block states (auto storage) for system '<S9>/If Action Subsystem1' */
typedef struct {
  int8_T IfActionSubsystem1_SubsysRanBC;/* '<S9>/If Action Subsystem1' */
} DW_IfActionSubsystem1_heli_q8_T;

/* Block signals for system '<S9>/If Action Subsystem' */
typedef struct {
  real_T In1;                          /* '<S12>/In1' */
} B_IfActionSubsystem_heli_q8_T;

/* Block states (auto storage) for system '<S9>/If Action Subsystem' */
typedef struct {
  int8_T IfActionSubsystem_SubsysRanBC;/* '<S9>/If Action Subsystem' */
} DW_IfActionSubsystem_heli_q8_T;
...
typedef struct {
  ...
  real_T Constant_e[36];               /* '<S8>/Constant' */
  real_T Constant1[12];                /* '<S8>/Constant1' */
  real_T Constant2[36];                /* '<S8>/Constant2' */
  real_T Sum1;                         /* '<Root>/Sum1' */
  real_T Sum2;                         /* '<Root>/Sum2' */
  real_T x_estimated[6];               /* '<S8>/MATLAB Function1' */
  real_T P_estimated[36];              /* '<S8>/MATLAB Function1' */
  real_T x_prior[6];                   /* '<S8>/MATLAB Function' */
  real_T P_prior[36];                  /* '<S8>/MATLAB Function' */
  uint8_T StreamCall1_o2;              /* '<S4>/Stream Call1' */
  B_IfActionSubsystem_heli_q8_T IfActionSubsystem2;/* '<S9>/If Action Subsystem2' */
  B_IfActionSubsystem_heli_q8_T IfActionSubsystem;/* '<S9>/If Action Subsystem' */
} B_heli_q8_T;
...
typedef struct {
  ...
  int8_T If1_ActiveSubsystem_f;        /* '<Root>/If1' */
  ...
  DW_IfActionSubsystem_heli_q8_T IfActionSubsystem2;/* '<S9>/If Action Subsystem2' */
  DW_IfActionSubsystem1_heli_q8_T IfActionSubsystem3;/* '<S9>/If Action Subsystem3' */
  DW_IfActionSubsystem_heli_q8_T IfActionSubsystem;/* '<S9>/If Action Subsystem' */
  DW_IfActionSubsystem1_heli_q8_T IfActionSubsystem1;/* '<S9>/If Action Subsystem1' */
} DW_heli_q8_T;
...
struct P_heli_q8_T_ {
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: (-2 * pi /4096)
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: -0.46
  ...
  real_T Constant1_Value;              /* Expression: 65
                                        ...
                                        */
  real_T Constant1_Value_c[5];         /* Expression: [0; 0; 0; 0; 0]
 ...
 * '<S3>'   : 'heli_q8/Heli 3D'
 * '<S4>'   : 'heli_q8/IMU'
 * '<S5>'   : 'heli_q8/If Action Subsystem1'
 * '<S6>'   : 'heli_q8/If Action Subsystem2'
 * '<S7>'   : 'heli_q8/Joystick'
 * '<S8>'   : 'heli_q8/Kalman filter'
 * '<S9>'   : 'heli_q8/Transformation'
 * '<S10>'  : 'heli_q8/Kalman filter/MATLAB Function'
 * '<S11>'  : 'heli_q8/Kalman filter/MATLAB Function1'
 * '<S12>'  : 'heli_q8/Transformation/If Action Subsystem'
 * '<S13>'  : 'heli_q8/Transformation/If Action Subsystem1'
 * '<S14>'  : 'heli_q8/Transformation/If Action Subsystem2'
 * '<S15>'  : 'heli_q8/Transformation/If Action Subsystem3'
 */
