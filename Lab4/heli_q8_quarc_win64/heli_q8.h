...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } Elevationrate_PWORK_a;             /* '<Root>/Elevationrate' */
...
struct P_heli_q8_T_ {
  real_T A1[25];                       /* Variable: A1
                                        * Referenced by: '<S8>/Gain1'
                                        */
  real_T B1[10];                       /* Variable: B1
                                        * Referenced by: '<S8>/Gain2'
                                        */
  real_T C1[25];                       /* Variable: C1
  ...
  real_T Constant_Value_i;             /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_b;            /* Expression: 65
 ...
 * '<S7>'   : 'heli_q8/Joystick'
 * '<S8>'   : 'heli_q8/State estimator'
 * '<S9>'   : 'heli_q8/Transformation'
 * '<S10>'  : 'heli_q8/Transformation/If Action Subsystem'
 * '<S11>'  : 'heli_q8/Transformation/If Action Subsystem1'
 * '<S12>'  : 'heli_q8/Transformation/If Action Subsystem2'
 * '<S13>'  : 'heli_q8/Transformation/If Action Subsystem3'
 */
